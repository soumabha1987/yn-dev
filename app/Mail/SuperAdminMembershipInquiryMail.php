...
class SuperAdminMembershipInquiryMail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: 'New Special Membership Request Received!',
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            markdown: 'emails.creditor.super-admin-membership-inquiry',
            with: [
