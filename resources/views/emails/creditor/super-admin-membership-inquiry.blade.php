...
<h2>Hello there!</h2>
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We have received a new membership inquiry from <b>{{ $company->company_name }}</b>.</p>


Please review the details at your earliest convenience and proceed accordingly.
