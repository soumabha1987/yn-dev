...
<x-mail::layout>
    ...
    {{ __('
            Please find attached the :frequency report schedule for the :reportType.
            This schedule outlines the frequency and timing of the reports related to :reportType',
            [
                'frequency' => $scheduleExport->frequency->value,
                'reportType' => $scheduleExport->report_type->displayName(),
            ]
        )
    }}.
