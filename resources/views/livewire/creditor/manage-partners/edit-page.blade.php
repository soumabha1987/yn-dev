        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 items-end gap-4">
            ...
            <div x-data="creditors_quota">
                <x-form.input-field
                    ...
                    x-bind:value="creditors_quota_value"
    ...
    @script
        <script>
            Alpine.data('creditors_quota', () => ({
                creditors_quota_value:'',
                init() {
                    if (this.$wire.form.creditors_quota) {
                        this.creditors_quota_value = this.formatWithCommasOnInit(this.$wire.form.creditors_quota)
                    }
                },

                formatWithCommas() {
                    this.creditors_quota_value = this.formatWithCommasOnInit(this.$event.target.value)
                    this.$wire.form.creditors_quota = this.creditors_quota_value.replace(/[,\s]/g, '');
                },

                formatWithCommasOnInit(value) {
