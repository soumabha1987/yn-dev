<div>
    @if ($this->personalizedLogo)
        <div x-on:set-header-logo.window="$wire.$refresh">
            <svg
                viewBox="-1135.6452 -3.6259 3009.5033 383.13" xmlns="http://www.w3.org/2000/svg"
                class="w-[170px] sm:w-[180px] lg:w-[200px] xl:w-[220px]"
                style="padding: 9px 0;"
            >
                <script xmlns=""/>
                <g transform="matrix(0.9999999999999999, 0, 0, 0.9999999999999999, -1578.105224609375, -858.02587890625)">
                    <polygon
                        ...
                        style="fill: {{ $this->personalizedLogo->primary_color }};"
                    />
                    <path
                    ...
                    <polygon
                        ...
                        style="fill: {{ $this->personalizedLogo->secondary_color }};"
                    />
                    <path
                    ...
                    <path
                        ...
                        style="fill: {{ $this->personalizedLogo->secondary_color }};"
                    />
                    <rect x="2497.51" y="872.46" width="59.73" height="50.04" style="fill: {{ $this->personalizedLogo->secondary_color }};"/>
                    <rect x="2497.51" y="950.21" width="59.73" height="204.38" style="fill: {{ $this->personalizedLogo->secondary_color }};"/>
                    <path
                    ...
                    <path
                        ...
                        style="fill: {{ $this->personalizedLogo->primary_color }};"
                    />
                    <circle cx="2232.99" cy="960.38" r="36.99" style="fill: {{ $this->personalizedLogo->primary_color }};"/>
                </g>
                <g transform="matrix(1.0358690023422241, 0, 0, 1.0989489555358887, -1694.444580078125, -946.2471923828125)" style="fill: {{ $this->personalizedLogo->secondary_color }};">
                    <text style="font-family: Arial, sans-serif;font-size: 38px;font-weight: 700;white-space: pre;" transform="matrix(2.950635, 0, 0, 2.884712, -6381.762207, -1750.011963)" x="3256.85" y="940.973">R</text>
                    <text style="font-family: Arial, sans-serif; font-size: 22.4px; white-space: pre;" x="3438.51" y="1007.84"> </text>
                </g>
                <g transform="matrix(0.9999999999999999, 0, 0, 0.9999999999999999, -1578.105224609375, -858.02587890625)" style="fill: {{ $this->personalizedLogo->secondary_color }};">
