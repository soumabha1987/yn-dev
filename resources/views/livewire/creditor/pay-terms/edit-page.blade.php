<div>
    ...
    >
        ...
        >
            <x-form.select
                wire:model="form.pay_terms"
                :label="__('Apply to :type', ['type' => match ($payTerms) {
                    'master-terms' => 'master',
                    'group-terms' => 'group',
                    'sub-account-terms' => 'sub account',
                }])"
                :options="$payTermsOption"
                name="form.pay_terms"
                class="w-1/2 mt-3 disabled:opacity-40 disabled:hover:border-slate-300"
            ...
            <div class="font-semibold text-xs+ my-5">
                {{ __('Please note the consumer will make up to 3 negotiation attempts. If their attempts do not meet your minimums above, we will provide them a final offer based on your term requirements. If they cannot afford your final offer, they will be directed to send you an offer they can afford. Be on the lookout in the Consumer Offers') }}
            </div>
