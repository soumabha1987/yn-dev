...
<x-dashboard.index-page route-name="creditor.dashboard.recently-completed-negotiations">
        ...
        <x-table>
            <x-slot name="tableHead">
                <x-table.tr>
                    ...
                    <x-table.th column="promise-date" :$sortAsc :$sortCol>{{ __('ORG. Promise Date') }}</x-table.th>
