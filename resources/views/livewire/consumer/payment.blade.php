    ...
    >
        ...
        <div class="flex card pt-6 pb-6 items-start w-full lg:w-2/3">
            <div class="flex flex-row lg:flex-col items-center lg:items-start w-full justify-between">
                <div class="px-6">
                    ...
                    <div class="flex flex-col text-black text-base mt-1">
                        <span>{{ __('Account Balance : ') }} {{ Number::currency((float) $consumer->current_balance) }}</span>
                    </div>
                    ...
                    @if ($isPif)
                        <div class="flex flex-col text-black text-sm mt-4">
                    ...
                    @if ($negotiation->negotiation_type === NegotiationType::INSTALLMENT)
                        ...
                        <div class="flex flex-col text-black text-base mt-1">
                            <span>
                                {{ __(
                                    ':count Payments of :monthly' . ($consumerNegotiation->last_month_amount > 0 ? ' and one last payment of :last' : ''),
                                    [
                        ...
                        <div class="flex p-1">
                            ...
                            @if (
                                ...
                                <button
                                    type="button"
                                    role="tab"
                                    x-on:click="method = 'helping-hand-link'"
                                    class="btn space-x-2 text-black shrink-0 px-3 py-1 text-xs+ transition-all delay-100 font-semibold hover:text-slate-800 focus:text-slate-800"
                                    x-bind:class="{
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 sm:gap-x-4">
                        ...
                        <div class="border rounded h-full inset-0 flex items-center justify-center py-10">
                            <div class="flex flex-col gap-4 justify-center items-center text-center">
                                ...
                                <p class="px-8 sm:px-12 lg:px-20 text-black">
                                    {{ __('Easily create a secure payment link that allows others to contribute on your behalf. Whether you need financial support from friends, family, or clients, this link simplifies the process—just share it, and they can complete the payment hassle-free.') }}
                                </p>
            ...
            <div class="card p-4 mt-8 sm:mt-0">
                ...
                <div class="col-span-12 rounded-lg bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-teal-600 via-blue-200 to-neutral-100 p-3 sm:col-span-6 xl:col-span-5">
